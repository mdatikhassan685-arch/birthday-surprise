...
// Matrix Rain কে একটি স্বাধীন ইফেক্ট হিসেবে সেট করা হলো
...
window.playNextSequence = function() {
    ...
    if (nextEffect === 'memory') {
        ...
        startHeartEffect();
        // হার্টস এবং ফায়ারওয়ার্কস ৬ সেকেন্ড চলার পর যদি আরও কিছু থাকে তবে প্লে করবে
        setTimeout(() => {
            window.playNextSequence();
        }, 6000); 
    } else {
...
// Memory Card Button Click Listener
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (mcBtn) {
        mcBtn.addEventListener('click', () => {
            const mcScreen = document.getElementById('memory-card-screen');
            if (mcScreen) mcScreen.style.display = 'none';
            // মেমোরি কার্ড বন্ধ করে পরেরটা প্লে করবে
            window.playNextSequence(); 
        });
    }
});
...
S = {
    initialized: false,
    init: function () {
        // ফাঁকা রাখা হয়েছে কারণ এটি এখন playMatrixAnimation() থেকে কন্ট্রোল হবে
    }
};
    ...
    function performAction(value) {
        ...
        timedAction(function (index) {
            ...
            switch (action) {
                ...
                // 🎯 নতুন কমান্ড: এনিমেশন শেষে পরের ইফেক্ট কল করবে
                case 'next':
                    const currentSettings = window.settings || {};
