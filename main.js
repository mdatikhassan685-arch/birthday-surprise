...
function checkOrientation() {
    ...
    // 🎯 রোটেশন ঠিক হলে কী হবে তার ফাংশন
    function handleReadyState() {
        if(orientationLock) orientationLock.style.display = 'none';
        
        if (!hasSurpriseStarted) {
            // যদি বাটনে চাপ না দিয়ে থাকে, তবে বাটন দেখাবে
            if(startScreen) startScreen.style.display = 'flex';
            if(matrixCanvas) matrixCanvas.style.display = 'none';
            if(mainCanvas) mainCanvas.style.display = 'none';
        } else {
            // বাটনে চাপ দেওয়া হয়ে গেলে এনিমেশন চলবে
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // পেজ লোড হলেই চেক করবে স্ক্রিন ল্যান্ডস্কেপ কিনা
    checkOrientation();
});
